...
angular.module('app', []).controller('EditOrdersCtrl', [
    '$scope', '$state', '$rootScope', 'OrdersFactory', 'OrderDetailsFactory', '$global', '$options', 'CustomersFactory', 'SalemstFactory', 'fileUpload', 'UrlHelper', 'ngDialog',
    function ($scope, $state, $rootScope, OrdersFactory, OrderDetailsFactory, $global, $options, CustomersFactory, SalemstFactory, fileUpload, UrlHelper, ngDialog) {
